...
import { useUpdateMeWhitelistIP } from '../../model/use-ip-whitelist'
import {
...
interface ViewIPWhitelistDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  whitelistIP: WhitelistIP | null
}

export function ViewIPWhitelistDrawer({
  open,
  onOpenChange,
  whitelistIP,
}: ViewIPWhitelistDrawerProps) {
  const updateMutation = useUpdateMeWhitelistIP()
  ...
  return (
    <FormDrawer
      ...
      formId="me-view-whitelist-ip-form"
